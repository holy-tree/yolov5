...
def convert_annotation(image_id):
    ...
    out_file = open('./YOLO/labels/%s.txt' % (image_id), 'w')
...
for image_set in sets:
    ...
    list_file = open('./YOLO/%s.txt' % (image_set), 'w')
    for image_id in image_ids:
        list_file.write('/media/work/data/zbt/yolov5/datasets/YOLO/images/%s.jpg\n' % (image_id))
